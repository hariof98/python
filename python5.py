...
# #print(customer['dob'])  # simply printing the variable throws keypair error in dictionaries if the variable is not available,so we are using .get() function to print the output
